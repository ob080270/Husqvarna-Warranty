...
'                 - # 9 Is64BitAccess   : Determines if Microsoft Access is running in 64-bit mode.
'                 - #10 GetMSCOMCTLPath : Retrieves the file path of `mscomctl.ocx` for 32-bit Access.
'
' Procedures :
'                 - #7 CheckClmTag          : Validates claim tag data.
'                 - #8 CheckAccessBitness   : Checks whether the user is running a 32-bit or 64-bit version of Access.
'
' Developer : Oleh Bondarenko
' Created   : 2003-04-17
' Updated   : 2025-02-19 by Oleh Bondarenko - Added comments for GitHub upload
'
' Updated   : 2025-02-23 by Oleh Bondarenko - Added:
'               Functions :
'                 - # 9 Is64BitAccess   : Determines if Microsoft Access is running in 64-bit mode.
'                 - #10 GetMSCOMCTLPath : Retrieves the file path of `mscomctl.ocx` for 32-bit Access.
'               Procedure :
...
' --------------------------------------------------------------------------
' Procedure #8    : CheckAccessBitness
